...
TEST(Breed, DefaultConstructor) {
  ...
  ASSERT_EQ(your_breed.BreedName(), "Pug") << "The default name should be Pug";
...
TEST(Pet, DefaultConstructor) {
  ...
  ASSERT_EQ(your_pet.GetBreed().BreedName(), "Pug")  << "The default Breed name should be Pug";
...
TEST(Pet, SetBreedOverload) {
  ...
  ASSERT_EQ(your_pet.GetBreed().BreedName(), "Pug") << "The name should be Pug";
